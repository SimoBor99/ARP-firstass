...
int main() {
  ...
  {"./mx", *file_name[2], NULL }, {"./mz", *file_name[3], NULL }, {"/usr/bin/konsole", "-e", "./world", *file_name[4], NULL }};
  //list of processes path
  char *process_path[][100]={{"/usr/bin/konsole"}, {"/usr/bin/konsole"}, {"./mx"}, {"./mz"}, {"/usr/bin/konsole"}};
