...
int main() {
  ...
  char *arg_lists[][100]= {{"/usr/bin/konsole", "-e", "./bin/command", NULL}, {"/usr/bin/konsole", "-e", "./bin/inspection", NULL}, 
  {"./bin/mx", NULL }, {"./bin/mz", NULL }, {"./bin/world", NULL }};
  //list of processes path
  char *process_path[][100]={{"./bin/command"}, {"./bin/inspection"}, {"./bin/mx"}, {"./bin/mz"}, {"./bin/world"}};
